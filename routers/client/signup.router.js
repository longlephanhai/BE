...
const upload = multer()
const { signup, signin, checkUserToken, logout, forgotPassword, otpPassword, resetPassword, loginGoogle } = require('../../controller/client/signup.controller')
...
routersignup.post('/login-google',loginGoogle)
